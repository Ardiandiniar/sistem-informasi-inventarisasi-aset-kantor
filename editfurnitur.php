...
<br>
	...
	<?php 
        ...
        $aset->Editfurnitur($id,$no_brg, $model, $merk, $status, $tgl, $th_beli, $jumlah, $stn_hrg ,$total);
        echo "<script>
          alert('Data Berhasil Diubah');
            window.location='tampilfurnitur.php';
        </script>";
        }
...
<div class="container mt-3">
  <h2>Edit Data Furnitur</h2>
  <form action="" method="POST">
    <div class="mb-3 mt-3">
      <?php
        require_once "oop/koneksi.php";
        $query = "SELECT * FROM crudfurnitur WHERE id=".$_GET['id'];
    ...
    <div class="mb-3">
      ...
      <input type="text" value="<?php echo $row['tgl_input']?>" class="form-control" id="tgl" name="tgl_input">
    </div>
    <div class="mb-3 mt-3">
      <label for="th_beli">tahun beli</label>
      <input type="text" value="<?php echo $row['th_beli']?>" class="form-control" id="th_beli" name="th_beli">
    </div>
    <div class="mb-3">
