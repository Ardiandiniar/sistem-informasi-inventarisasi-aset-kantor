...
<br>
	...
	<?php 
        ...
        $aset->Editelektronik($id,$no_brg, $model, $merk, $status, $tgl, $th_beli, $jumlah, $stn_hrg);
        echo "<script>
          alert('Data Berhasil Diubah');
            window.location='tampilelektronik.php';
        </script>";
        }
...
<div class="container mt-3">
  <h2>Edit Data Elektronik</h2>
  <form action="" method="POST">
    <div class="mb-3 mt-3">
      <?php
        require_once "oop/koneksi.php";
        $query = "SELECT * FROM crudelektronik WHERE id=".$_GET['id'];
    ...
    <div class="mb-3 mt-3">
      ...
      <input type="text" value="<?php echo $row['merk']?>" class="form-control" id="merk" name="merk">
    </div>
   
    <div class="mb-3 mt-3">
      <label for="status">status</label>
      <input type="text" value="<?php echo $row['status']?>" class="form-control" id="status" name="status">
    </div>
    <div class="mb-3">
      <label for="tgl_input">tanggal input</label>
      <input type="date" value="<?php echo $row['tgl_input']?>" class="form-control" id="tgl" name="tgl_input">
    </div>
    <div class="mb-3 mt-3">
      <label for="th_beli">tahun beli</label>
      <input type="date" value="<?php echo $row['th_beli']?>" class="form-control" id="th_beli" name="th_beli">
    </div>
    <div class="mb-3">
      <label for="jumlah">jumlah</label>
      <input type="text" value="<?php echo $row['jumlah']?>" class="form-control" id="jumlah" name="jumlah">
    </div>
    <div class="mb-3 mt-3">
      <label for="stn_hrg">satuan harga</label>
      <input type="text" value="<?php echo $row['stn_hrg']?>" class="form-control" id="stn_hrg" name="stn_hrg">
    </div>
        <?php
...
<footer>
	<div
         ...
         >
      © <b>2021 Copyright: Ardian Mulya Diniar & Muhamad Adzriel Akbar</b>
