...
class Elektronik {
    ...
    public function TampilElektronik ($query){
        ...
        while($row = $query->fetch(PDO::FETCH_ASSOC))
        {
            ...
            <td>
                <a href="oop/class_hapus.php?id_elektronik='<?php echo $row['id'] ?>'" onclick='return confirm("apakah anda ingin menghapus?");' class='btn btn-danger'><span class='bi bi-trash'></span></a>
            </td>
            <td> 
